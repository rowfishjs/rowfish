...
export const works: WorkCardItemType[] = [
    ...
    {
        img: require('@site/static/custom/rowfish-pro-thumbnail.png').default,
        name: 'Rowfish Pro',
    ...
    {
        img: require('@site/static/custom/talejs-thumbnail.png').default,
        name: 'Talejs',
    ...
    {
        img: require('@site/static/custom/toome-thumbnail.png').default,
        name: '荼蘼(toome)',
