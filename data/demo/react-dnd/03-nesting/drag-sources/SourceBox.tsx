import React, { CSSProperties, FC, useState, useCallback, useMemo, memo, ReactNode } from 'react';
...
export const SourceBox: FC<SourceBoxProps> = memo(function SourceBox({ color, children }) {
