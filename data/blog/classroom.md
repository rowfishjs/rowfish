---
slug: classroom
title: 极速教室 -- 系统学习全栈开发,寻找更好更自由的远程工作
type: image
...
[极速教室][classroom]是[平克小站][site]推出的一个旨在帮助大家快速掌握TS全栈开发技能，同时为同学们提供远程工作求职和承接外包指导的服务。帮助各位在失业或者高压低薪中苦苦挣扎走钢丝的Coder朋友以最快的速度找到远程工作或自由接单，实现生活与工作分离的梦想，目标是——**在自由轻松的环境中把钱给赚了**
...
站长一开始的想法只是为了做一些免费的视频教程(比如《Nestjs最佳实践》，《React18最佳实践》等)帮助大家学习一些TS全栈开发的技能。但是慢慢发觉很多同学不仅仅是对技术方面感兴趣，对远程工作和接外包单子更加感兴趣。所以站长打算利用业余时间构建一个与大家互利互惠一起进步的**全栈开发学习与变现一条龙**的基地，这就是**平克教室**诞生的原因
...
对于无任何计算机编程基础者，为了保证学习质量，只提供一对二教学服务
